...
func (srv *Server) WithLog() *Server {
	if srv.httpSubscription != nil {
		srv.httpSubscription = srv.Subscription().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpSubscription != nil {
		srv.httpSubscription = srv.Subscription().WithMetrics()
	}
	return srv
}

func (srv *Server) Subscription() *httpSubscription {
	return srv.httpSubscription
}
